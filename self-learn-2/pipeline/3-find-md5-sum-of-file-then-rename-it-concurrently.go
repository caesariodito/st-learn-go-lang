...
// 	chanFileSum4 := getSum(chanFileContent)
// 	chanFileSum5 := getSum(chanFileContent)
// 	chanFileSum := mergeChanFileInfo(chanFileSum1, chanFileSum2, chanFileSum3, chanFileSum4, chanFileSum5)
...
// 	chanRename := mergeChanFileInfo(chanRename1, chanRename2, chanRename3, chanRename4, chanRename5)
...
// 	fmt.Println("Calculating md5sum...")
// 	n := <-chanOut
// 	fmt.Println(n.FilePath)
...
// 	fmt.Println("Merging channels of calculation Md5sum ...")
// 	n := <-chanOut
// 	fmt.Println(n.FilePath)
